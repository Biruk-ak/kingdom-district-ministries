...
export const GlobalImpact = () => {
    return (
        <section className="relative w-full min-h-[120vh] py-12 md:py-16 overflow-hidden text-center flex flex-col items-center justify-between">
            ...
            <div className="relative z-10 container mx-auto px-6 md:px-12 flex flex-col items-center gap-6">
            ...
            <div className="relative z-10 w-full flex justify-center pb-4 md:pb-8">
                <button className="flex items-center gap-3 px-10 py-4 bg-primary text-white rounded-md font-medium hover:bg-primary/90 transition-all shadow-lg hover:shadow-xl active:translate-y-0.5 text-lg">
